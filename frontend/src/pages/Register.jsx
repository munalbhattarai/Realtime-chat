...
const Register = () => {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-10 spidey-web-bg relative overflow-hidden font-sans">
      {/* Background decoration */}
      <div className="absolute top-[-10%] right-[-10%] h-[50%] w-[50%] rounded-full bg-red-600/15 blur-[140px]" />
      <div className="absolute bottom-[-10%] left-[-10%] h-[50%] w-[50%] rounded-full bg-blue-600/15 blur-[140px]" />
